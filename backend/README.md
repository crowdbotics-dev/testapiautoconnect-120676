...
## Project Structure
    ...
    ├── testapiautoconnect_120676  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_120676`
...
2. Clone this repo and `cd testapiautoconnect_120676`
